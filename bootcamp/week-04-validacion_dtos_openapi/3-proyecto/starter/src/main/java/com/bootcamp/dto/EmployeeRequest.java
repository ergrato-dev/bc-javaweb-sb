...
public record EmployeeRequest(
    ...
    @Schema(description = "Work email address", example = "alice.johnson@company.com")
    @NotBlank(message = "Email is required")
    @Email(message = "Must be a valid email address")
    String email,

    @Schema(description = "Age in years", example = "30", minimum = "18", maximum = "65")
    ...
    @Schema(description = "Job position title", example = "Senior Software Engineer")
