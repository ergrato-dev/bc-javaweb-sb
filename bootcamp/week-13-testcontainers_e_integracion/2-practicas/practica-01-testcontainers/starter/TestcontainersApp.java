...
public class TestcontainersApp {
    ...
    // ============================================
    // Este test NO usa Docker — solo verifica que la clase PostgreSQLContainer existe.
    // Descomenta:
    ...
    //         var product = productRepository.save(new Product("Widget A", "SKU-001", 9.99));
    //
    ...
    // @AutoConfigureTestDatabase(replace = NONE) — NO usar H2, usar nuestro contenedor
    // Descomenta:
