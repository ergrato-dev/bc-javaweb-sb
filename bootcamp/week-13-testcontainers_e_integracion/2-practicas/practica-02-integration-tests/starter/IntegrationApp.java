 ...
 *
 * Requisito: Docker corriendo + la API debe estar configurada (usa el proyecto de la semana)
 *
 * Los tests comentados son PATRONES a descomentar y adaptar al proyecto de la semana.
...
public class IntegrationApp {
    ...
    //         // Un endpoint de listado siempre retorna 200 (con lista vacía si no hay datos)
    ...
    //         var response = restTemplate.getForEntity("/api/products/999999", Object.class);
    ...
    //     void step2_read() {
    //         var response = rest.getForEntity("/api/products/" + createdId, ProductResponse.class);
    //
    //         assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
    ...
    //     void step3_update() {
    //         var update = new ProductUpdateRequest("Widget Pro v2", BigDecimal.valueOf(34.99));
    //         rest.put("/api/products/" + createdId, update);
    //
    //         var updated = rest.getForEntity("/api/products/" + createdId, ProductResponse.class);
