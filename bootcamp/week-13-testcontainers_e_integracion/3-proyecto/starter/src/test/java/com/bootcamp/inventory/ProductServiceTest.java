...
class ProductServiceTest {
    ...
    class FindAll {
        ...
        void useSearchWhenNameProvided() {
            // TODO: Implementar
            // given: productRepository.searchByName("%laptop%") retorna lista con 1 producto
    ...
    class Create {
        ...
        void savesProduct() {
            ...
            // when: productService.create(new ProductCreateRequest("Teclado", "SKU-NEW", 49.99, 30, "PERIPH"))
