...
/**
 * ProductApiIntegrationTest — Tests de integración full HTTP → Service → PostgreSQL.
 *
...
class ProductApiIntegrationTest extends AbstractIntegrationTest {
    ...
    class Create {
        ...
        void returns201() {
            // TODO: Implementar
            // 1. Usar restTemplate.postForEntity("/api/products", validRequest("SKU-001"), ProductResponse.class)
