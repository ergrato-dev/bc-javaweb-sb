 ...
 *
 * Sigue los pasos en orden. Descomenta cada sección cuando llegues al paso
 * correspondiente.
 * Después de cada paso, prueba la aplicación con curl para verificar el
 * comportamiento.
 */
public class SecurityApp {
  ...
  // )
  // // HTTP Basic: envía credenciales en el header Authorization: Basic
  // base64(user:pass)
