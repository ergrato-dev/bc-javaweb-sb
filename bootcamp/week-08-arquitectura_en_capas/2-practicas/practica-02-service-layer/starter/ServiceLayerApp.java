...
//     @ManyToOne(fetch = FetchType.LAZY) @JoinColumn(name = "member_id") Member member;
...
//         this.status = returnedAt.isAfter(dueAt) ? LoanStatus.OVERDUE : LoanStatus.RETURNED;
//     }
// }
...
//         long active = loanRepository.countByMember_IdAndStatus(memberId, LoanStatus.ACTIVE);
...
//         super("Member " + memberId + " has reached the limit of " + limit + " active loans");
//     }
// }
// class BookNotAvailableException extends RuntimeException {
//     BookNotAvailableException(Long id) { super("Book " + id + " is not available"); }
// }
