...
public class Product {
    ...
    public Product(String name, String description, BigDecimal price, int stock, String category) {
        ...
        this.stock = stock; this.category = category; this.createdAt = LocalDateTime.now();
    }
    ...
    public void decrementStock(int qty) {
        if (this.stock < qty) throw new IllegalStateException("Insufficient stock for product: " + id);
        this.stock -= qty;
    }
}
