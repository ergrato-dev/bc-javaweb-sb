 ...
 * get("/api/books"), post("/api/books"), put("/api/books/1"),
 * delete("/api/books/1")
...
class BookControllerTest {
  ...
  class GetAll {
    ...
    void returns200() throws Exception {
      ...
      // new PageImpl<>(List.of(makeResponse(1L, "Clean Code"), makeResponse(2L,
      // "Refactoring")))
      // 2. mockMvc.perform(get("/api/books"))
      // 3. Verificar: status 200, $.content es array, $.content[0].title == "Clean
      // Code"
    }
  }
  ...
  class CreateBook {
    ...
    void returns201() throws Exception {
      // TODO: Implementar
      // 1. Crear BookCreateRequest("Clean Code", "9780132350884", "Author",
    ...
    void returns409OnDuplicateIsbn() throws Exception {
      // TODO: Implementar
      // 1. Request válido
      // 2. Stubbear create() → throw IllegalArgumentException("Book with ISBN...
      // already exists")
