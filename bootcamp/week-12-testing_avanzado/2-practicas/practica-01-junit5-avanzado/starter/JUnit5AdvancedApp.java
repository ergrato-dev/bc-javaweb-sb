...
public class JUnit5AdvancedApp {
    ...
    static class BookService {
        ...
        BookResponse create(BookRequest request) {
            if (request.title().isBlank()) throw new IllegalArgumentException("Title required");
            if (!IsbnUtils.isValid(request.isbn())) throw new IllegalArgumentException("Invalid ISBN");
    ...
    //
    //     @ParameterizedTest
    //     @ValueSource(strings = {"Clean Code", "The Pragmatic Programmer", "Refactoring"})
    ...
    //         void returnsBook() {
    //             var created = service.create(new BookRequest("Refactoring", "9780201485677", 39.99));
    ...
    //         var book = service.create(new BookRequest("TDD By Example", "9780321146533", 34.99));
    //         createdId = book.id();
    ...
    //     void softAssertions() {
    //         var book = service.create(new BookRequest("Clean Code", "9780132350884", 29.99));
    //
