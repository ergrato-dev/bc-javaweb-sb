...
public class MockitoAdvancedApp {
  ...
  //
  // var service = new LoanService(bookRepository, loanRepository,
  // notificationService);
  ...
  //
  // var realService = new LoanService(bookRepository, loanRepository,
  // notificationService);
  ...
  // verify(notificationService, never()).sendLoanConfirmation(any(), any()); //
  // nunca
  // }
  //
  // @Test
  ...
  // service.createLoan("alice", 1L, 14);
  //
  // // 1ro: buscar libro, 2do: guardar libro (mark unavailable), 3ro: guardar
  // préstamo
