...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        //
        // 2. Si no existe o no empieza con "Bearer ", llamar filterChain.doFilter() y return
        //
        ...
        //    c. Si válido, crear UsernamePasswordAuthenticationToken y establecer en SecurityContext:
