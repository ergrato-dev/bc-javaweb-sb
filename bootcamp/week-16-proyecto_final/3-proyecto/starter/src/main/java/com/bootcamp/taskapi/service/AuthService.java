...
public class AuthService {
    ...
    // ============================================
    // 1. Verificar que username no exista: userRepository.existsByUsername(req.username())
    ...
    //    );
    //    Si el password es incorrecto, AuthenticationManager lanza BadCredentialsException
    ...
    //    Para el role, puedes usar: userDetails.getAuthorities().iterator().next().getAuthority()
    //    (retorna "ROLE_USER" o "ROLE_ADMIN" — puedes hacer substring(5) para quitar "ROLE_")
    //
