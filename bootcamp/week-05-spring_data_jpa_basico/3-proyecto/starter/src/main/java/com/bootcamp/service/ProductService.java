...
public class ProductService {
  ...
  /**
   * TODO:
   * 1. If category is not null: return productRepository.findByCategory(category,
   * pageable)
   * mapped to Page<ProductResponse>
   * 2. Otherwise: return productRepository.findAll(pageable) mapped to
  ...
  /**
   * TODO:
   * 1. Use productRepository.findById(id).orElseThrow(() -> new
   ...
   * 2. If result == 0 → throw ProductNotFoundException or
